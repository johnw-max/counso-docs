# List agent consumption analytics facets

Return the available consumption filters for one agent in the selected period. Workspace managers and editors of that agent can use this route. The agent dimension is omitted, and active filters determine which other values are available.
...
| --- | --- | --- | --- | --- |
| `wId` | path | string | Yes |  |
| `aId` | path | string | Yes | ID of the agent configuration |
