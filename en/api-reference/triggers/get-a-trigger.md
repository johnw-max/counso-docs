...
Retrieve one scheduled-run or webhook trigger by its ID using a workspace-admin API key.
...
| `tId` | path | string | Yes | ID of the trigger |
...
| 404 | Workspace or trigger not found. |
