...
Private session interface. Removes a selected data source view.
...
| `force` | query | string | No | Force deletion even if the view is in use Values: `true` |

## Responses

| HTTP status | Description |
| --- | --- |
| 204 | Successfully deleted data source view |
| 401 | Unauthorized |
