...
Private session interface. Removes a workspace file unless a Skill or its version history still references it.
...
| --- | --- |
| 204 | File deleted |
| 400 | File is referenced by a skill or its version history |
