...
Accepts a JSON representation that conforms to the agent-config schema and creates a new configuration from it.
...
| `generation_settings` | object | Yes |
| `tags` | array[object] | Yes |
| `editors` | array[string / email] | Yes |
| `toolset` | array[object] | Yes |
...
| --- | --- |
| 200 | Successfully created agent configuration |
