...
1. With Counso admin access and GitHub administrator permissions to install the app for the selected repositories, open **Spaces > Connections > GitHub**.
2. Choose **Configure** and complete the GitHub authorization and installation flow.
