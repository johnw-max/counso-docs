...
topicId: "integrations/connections-and-tools"
contentRevision: "45"
---
...
For provider-specific procedures, see [Google](/en/integrations/google/#google-connections-and-tools), [Microsoft](/en/integrations/microsoft/#microsoft-connections-and-tools), [Slack](/en/integrations/slack/#slack-connections-and-tools), [Notion](/en/integrations/notion/#notion-connection-and-tools), [Confluence](/en/integrations/confluence/#confluence-connection-and-tools), [Gong](/en/integrations/gong/#gong-connection-and-tools), and [data platforms](/en/integrations/data-platforms/#data-platform-connections-and-tools).
