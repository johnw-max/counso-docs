...
For Agent Memory, delegation, and scheduled prompts, use [advanced work modes](/en/agents/advanced-work-modes/#choose-an-advanced-agent-work-mode).
...
See [connections and tools](/en/integrations/connections-and-tools/#connections-and-tools), [personal and shared access](/en/integrations/personal-and-shared/#personal-and-shared-credentials), and [remote MCP](/en/integrations/remote-mcp/#add-a-remote-mcp-server).
