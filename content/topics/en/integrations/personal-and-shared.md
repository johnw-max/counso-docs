...
See [Connections and tools](./connections-and-tools.md#connections-and-tools) for the general model and [remote MCP](./remote-mcp.md#add-a-remote-mcp-server) for server-specific ownership.
