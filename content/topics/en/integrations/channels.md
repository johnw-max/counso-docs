...
Slack data synchronization, personal tools, and channel workflows have different identities and scopes. Use the [Slack guide](./slack.md#slack-connections-and-tools) for channel selection, message permissions, and the difference between a connection and a tool.
...
Webhook filters select which incoming events may start a run. Define the event fields, authentication or signature requirements, and destination before enabling a source. See [Webhook triggers](../automations/webhooks.md#trigger-an-agent-with-a-webhook).
...
[Documentation index](../../../indexes/en.md) · [简体中文](../../../indexes/zh-cn.md#连接与工具)
