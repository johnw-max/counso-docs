...
Use a small, non-sensitive request to review the configured Agent. For access boundaries, read [Manage Agent data and access](./data-and-access.md#manage-agent-data-and-access); for the editor's inspection tools, read [Preview and improve an Agent](./preview-and-improve.md#preview-and-improve-an-agent).
