...
For the surrounding configuration, read [Add capabilities and knowledge](./capabilities-and-knowledge.md#add-capabilities-and-knowledge) and [Preview and improve an Agent](./preview-and-improve.md#preview-and-improve-an-agent).
