...
For ongoing collaboration, keep the result in a Pod with the appropriate membership and refer to the same file in later requests. See [Pod files](../pods/files.md#work-with-pod-files) and [Connections and operation tools](../integrations/connections-and-tools.md#connections-and-tools).
