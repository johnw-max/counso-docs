...
Power BI 有独立的设置和 API 权限。参阅 [Power BI](./power-bi.md#power-bi-工具) 完成 Entra 应用、租户设置和 MCP 字段。应用注册本身不等于 Power BI 已连接，要验证一个允许的 workspace 或 model 读取。
...
参阅[连接与工具](./connections-and-tools.md#连接与工具)和[个人与共享访问](./personal-and-shared.md#个人与共享授权)。
