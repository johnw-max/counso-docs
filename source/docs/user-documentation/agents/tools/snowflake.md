...
Dust offers two ways to connect agents to Snowflake: the **Snowflake Tool** (this page) and the [Snowflake Connection](/docs/user-documentation/admins/connections-management/snowflake). They serve different needs.
