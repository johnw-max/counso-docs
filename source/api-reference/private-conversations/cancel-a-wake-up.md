...
````yaml https://raw.githubusercontent.com/dust-tt/dust/refs/heads/main/front-api/public/swagger.json delete /api/w/{wId}/assistant/conversations/{cId}/wakeups/{wuId}
openapi: 3.0.0
info:
...
paths:
  /api/w/{wId}/assistant/conversations/{cId}/wakeups/{wuId}:
    delete:
      ...
      description: >-
        Cancel a scheduled wake-up. Only the wake-up owner or a workspace admin
        can cancel.
      parameters:
        - in: path
          name: wId
