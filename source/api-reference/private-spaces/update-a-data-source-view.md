...
````yaml https://raw.githubusercontent.com/dust-tt/dust/refs/heads/main/front-api/public/swagger.json patch /api/w/{wId}/spaces/{spaceId}/data_source_views/{dsvId}
openapi: 3.0.0
info:
