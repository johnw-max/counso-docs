...
````yaml https://raw.githubusercontent.com/dust-tt/dust/refs/heads/main/front-api/public/swagger.json get /api/v1/w/{wId}/spaces/{spaceId}/data_sources/{dsId}/tables
openapi: 3.0.0
info:
...
paths:
  /api/v1/w/{wId}/spaces/{spaceId}/data_sources/{dsId}/tables:
    get:
      ...
      summary: Get tables
      description: >-
        Get tables in the data source identified by {dsId} in the workspace
        identified by {wId}.
      parameters:
        - in: path
          name: wId
