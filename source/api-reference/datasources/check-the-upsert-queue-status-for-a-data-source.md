...
````yaml https://raw.githubusercontent.com/dust-tt/dust/refs/heads/main/front-api/public/swagger.json get /api/v1/w/{wId}/spaces/{spaceId}/data_sources/{dsId}/check_upsert_queue
openapi: 3.0.0
info:
...
paths:
  /api/v1/w/{wId}/spaces/{spaceId}/data_sources/{dsId}/check_upsert_queue:
    get:
      ...
      description: >-
        Returns the number of running document upsert workflows for this data
        source. This endpoint is only accessible with system API keys (e.g.,
        from connectors).
      parameters:
        - in: path
          name: wId
