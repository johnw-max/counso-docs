...
````yaml https://raw.githubusercontent.com/dust-tt/dust/refs/heads/main/front-api/public/swagger.json delete /api/w/{wId}/assistant/conversations/{cId}/messages/{mId}/feedbacks
openapi: 3.0.0
info:
