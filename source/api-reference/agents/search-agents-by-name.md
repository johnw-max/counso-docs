...
````yaml https://raw.githubusercontent.com/dust-tt/dust/refs/heads/main/front-api/public/swagger.json get /api/v1/w/{wId}/assistant/agent_configurations/search
openapi: 3.0.0
info:
...
paths:
  /api/v1/w/{wId}/assistant/agent_configurations/search:
    get:
      ...
      description: >-
        Search for agent configurations by name in the workspace identified by
        {wId}.
      parameters:
        - in: path
          name: wId
