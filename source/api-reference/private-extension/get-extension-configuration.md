...
````yaml https://raw.githubusercontent.com/dust-tt/dust/refs/heads/main/front-api/public/swagger.json get /api/w/{wId}/extension/config
openapi: 3.0.0
info:
...
paths:
  /api/w/{wId}/extension/config:
    get:
      ...
      description: >-
        Returns the extension configuration for the workspace, including
        blacklisted domains.
      parameters:
        - in: path
          name: wId
