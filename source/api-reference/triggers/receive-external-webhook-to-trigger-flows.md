...
````yaml https://raw.githubusercontent.com/dust-tt/dust/refs/heads/main/front-api/public/swagger.json post /api/v1/w/{wId}/triggers/hooks/{webhookSourceId}
openapi: 3.0.0
info:
...
paths:
  /api/v1/w/{wId}/triggers/hooks/{webhookSourceId}:
    post:
      ...
      description: >-
        Skeleton endpoint that verifies workspace and webhook source and logs
        receipt.
      parameters:
        - name: wId
          in: path
